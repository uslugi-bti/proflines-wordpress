                    ...
                    <div class="columns__body">
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/01.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/02.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/03.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/04.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/05.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/06.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/07.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/08.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/09.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/10.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/11.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/12.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/13.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/14.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
                        ...
                        <div class="columns__item">
                            <a href>
                                <div class="columns-item__head">
                                    <div class="columns-item__icon">
                                        <img src="<?php bloginfo('template_url'); ?>/assets/img/services/icons/15.svg" loading="lazy" alt="icon">
                                    </div>
                                    <div class="columns-item__title">
